...
namespace Caratlane\NetSuite\Model\ResourceModel\NetSuiteOrdersUpdate;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Caratlane\NetSuite\Model\NetSuiteOrdersUpdate::class,
            \Caratlane\NetSuite\Model\ResourceModel\NetSuiteOrdersUpdate::class
        );
    }
}
