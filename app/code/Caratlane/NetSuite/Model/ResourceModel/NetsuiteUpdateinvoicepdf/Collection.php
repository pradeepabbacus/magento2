...
namespace Caratlane\NetSuite\Model\ResourceModel\NetsuiteUpdateinvoicepdf;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Caratlane\NetSuite\Model\NetsuiteUpdateinvoicepdf::class,
            \Caratlane\NetSuite\Model\ResourceModel\NetsuiteUpdateinvoicepdf::class
        );
    }
}
