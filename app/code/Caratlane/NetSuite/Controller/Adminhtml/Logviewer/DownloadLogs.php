...
/**
 * DownloadLogs log from controller
 */
class DownloadLogs extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->fileDriver->isExists($fileAbsolutePath)) {
            ...
            $content['value'] = $fileAbsolutePath;
            $content['rm'] = 0;
            return $this->fileFactory->create($logfile, $content, DirectoryList::VAR_DIR);
        } else {
